...
jsonform.elementTypes = {
  ...
  'array': {
    'template': function(node) {
      var template = '<div id="<%= id %>"><ul class="_jsonform-array-ul" style="list-style-type:none;"><%= children %></ul>' +
      '<span class="_jsonform-array-buttons">';
      if (!(node && node.schemaElement && node.schemaElement['readOnly'] === true)) {
        template += '<a href="#" class="btn _jsonform-array-addmore"><i class="icon-plus-sign" title="Add new"></i></a> ';
        if (!$('').sortable) {
          template += '<a href="#" class="btn _jsonform-array-deletelast"><i class="icon-minus-sign" title="Delete last"></i></a>';
        }
      }
      template += '</span></div>';
      return template;
    ...
    'childTemplate': function (inner, parent) {
      if ($('').sortable) {
        ...
        var template = '<li data-idx="<%= node.childPos %>">' +
	      '<span class="draggable line"><i class="icon-list" title="Move item"></i></span> ';
        if (isSet(parent) && isSet(parent.schemaElement) && parent.schemaElement['readOnly'] !== true) {
	        template += '<a href="#" class="_jsonform-array-item-delete"><i class="icon-remove" title="Remove item"></i></a>';
        }
        template += inner + '</li>';
        return template;
      }
...
formNode.prototype.clone = function (parentNode) {
  ...
  node.schemaElement = $.extend(true, {}, this.schemaElement);
  node.view = this.view;
...
formNode.prototype.computeInitialValues = function (values, ignoreDefaultValues) {
  ...
  if (isSet(this.parentNode) && isSet(this.parentNode.schemaElement) && isSet(this.parentNode.schemaElement['default']) && (!isSet(this.schemaElement) || !isSet(this.schemaElement['default']))) { 
    var key = this.key.split(".").pop();
    this.schemaElement['default'] = this.parentNode.schemaElement['default'][key];
  }
  ...
  if (this.view && this.view.inputfield && this.schemaElement) {
    ...
    if (values) {
      ...
      if (isSet(jsonform.util.getObjKey(values, this.key))) {
        newValue = jsonform.util.getObjKey(values, this.key);
      }
    }
    if (newValue) {
        this.value = newValue;
    ...
    var newValue = null;
    if (values) {
      newValue = this.getPreviousNumberOfItems(values, this.arrayPath);
    }
    ...
    for (i = 0; i < nbChildren; i++) {
      ...
      if (!isSet(child.schemaElement['default'])) {
        var newDefault = null;
        if (isSet(this.schemaElement['default'])) {
            if (typeof this.schemaElement['default'][i] === 'string') {
              newDefault = this.schemaElement['default'][i];
            } else if (typeof this.schemaElement['default'][i] === 'object') {
              newDefault = $.extend(true, {}, this.schemaElement['default'][i]);
            }
        }
        child.schemaElement['default'] = newDefault;
      }
  ...
  //if (this.schemaElement) this.schemaElement['default'] = null;
};
