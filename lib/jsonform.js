...
jsonform.elementTypes = {
  ...
  'array': {
    'template': function(node) {
      ...
      if (isSet(node) && isSet(node.schemaElement) && node.schemaElement['readOnly'] !== true) {
    ...
    for (i = 0; i < nbChildren; i++) {
      ...
      if (!isSet(child.schemaElement['default'])) {
        if (typeof this.schemaElement['default'][i] === 'string') {
          child.schemaElement['default'] = this.schemaElement['default'][i];
        } else {
          child.schemaElement['default'] = $.extend(true, {}, this.schemaElement['default'][i]);
        }
      }
